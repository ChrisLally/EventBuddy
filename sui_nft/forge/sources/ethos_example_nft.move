module ethos::ethos_example_nft {
    ...
    public struct EthosNFT has key, store {
        id: UID,
        name: String,
        description: String,
        url: Url,
    ...
    public struct ETHOS_EXAMPLE_NFT has drop {}
    ...
    fun init(otw: ETHOS_EXAMPLE_NFT, ctx: &mut TxContext) {
        ...
        let mut display = display::new_with_fields<EthosNFT>(
